...
def test_dataset_service():
    ...
    try:
        ...
        print(f"  - Columns: {len(dataset.columns_info['columns']) if dataset.columns_info else 0}")
...
def test_prediction_service():
    ...
    try:
        ...
        print(f"✓ Prediction statistics: {stats['total_predictions']} total predictions")
