...
from ..schemas import TransactionCreate, TransactionResponse, FinancialSummaryResponse
from ..auth import get_current_user, require_role
from ..services.financial_service import get_financial_services, TransactionType, TransactionStatus, RiskLevel
...
async def create_transaction(
    ...
    try:
        ...
        limit_check = financial_services["compliance_monitoring"].monitor_transaction_limits(
            user_id=current_user.id,
            transaction_amount=transaction.amount,
            transaction_type=TransactionType(transaction.transaction_type)
        )
        ...
        if not limit_check["compliant"]:
            audit_logger.log_security_event(
                ...
                details={"reason": "limit_exceeded", "violations": limit_check["violations"]}
            )
            raise HTTPException(
        ...
        return TransactionResponse(
            ...
            compliance_status="compliant" if limit_check["compliant"] else "non_compliant"
        )
...
async def approve_transaction(
    ...
    try:
        ...
        return {"message": "Transaction approved successfully", "transaction_id": transaction_id}
...
async def reject_transaction(
    ...
    try:
        ...
        return {"message": "Transaction rejected successfully", "transaction_id": transaction_id}
...
async def get_transaction_limits(
    ...
    try:
        ...
        limit_info = financial_services["compliance_monitoring"].monitor_transaction_limits(
            user_id=current_user.id,
        ...
        return {
            ...
            "compliance_status": "compliant" if limit_info["compliant"] else "non_compliant"
        }
...
async def calculate_interest(
    ...
    try:
        financial_services = get_financial_services(None)  # Calculation service doesn't need DB
